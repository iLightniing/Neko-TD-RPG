...
<template>
    <div class="flex flex-col items-center gap-4">
            ...
            <Icon name="lucide:swords" class="w-6 h-6 text-indigo-400" />
            </div>
            <div class="text-indigo-400 font-bold tracking-widest text-xs animate-pulse uppercase">{{ message || 'CHARGEMENT...' }}</div>
    </div>
</template>